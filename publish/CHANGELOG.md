...
```
```markdown
- Replaced transpiler with Prefix/Finalizer for better compatibility.
- Changed sneak speed from additive to multiplicative.
- Removed Jotunn dependency (BepInEx only).
- Removed unnecessary Enable/Disable config toggle.
- Added null checks for Player.m_localPlayer.
- Added SneakSkill constant.
